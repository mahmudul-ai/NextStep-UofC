...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Student',
            fields=[
                ('UCID', models.IntegerField(db_column='UCID', primary_key=True, serialize=False, unique=True, validators=[django.core.validators.MaxValueValidator(39999999), django.core.validators.MinValueValidator(30000000)])),
        ...
        migrations.CreateModel(
            name='Employer',
            fields=[
                ('EmployerID', models.AutoField(db_column='EmployerID', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Moderator',
            fields=[
                ('ModeratorID', models.OneToOneField(db_column='ModeratorID', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='api.student')),
            ],
            options={
                'db_table': 'moderator',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('EmployerID', models.ForeignKey(db_column='EmployerID', on_delete=django.db.models.deletion.CASCADE, to='api.employer')),
                ('JobID', models.ForeignKey(db_column='JobID', on_delete=django.db.models.deletion.CASCADE, to='api.jobopening')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('EmployerID', models.ForeignKey(db_column='EmployerID', on_delete=django.db.models.deletion.CASCADE, to='api.employer')),
                ('ModeratorID', models.ForeignKey(db_column='ModeratorID', on_delete=django.db.models.deletion.CASCADE, to='api.moderator')),
            ],
            options={
